    ...
    <Card className='max-w-5xl mx-auto p-4'>
      ...
      <CardContent>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4 mb-4'>
          <input type='text' placeholder='Titulo' className='px-4 py-2 border rounded-md w-full' />
          <input
            type='text'
            placeholder='Custo médio'
            className='px-4 py-2 border rounded-md w-full'
          />
          <input type='number' placeholder='Dias' className='px-4 py-2 border rounded-md w-full' />
          <div className='col-span-2'>
            <label className='block mb-2'>Selecionar imagem de capa</label>
            <input type='file' className='border rounded-md p-2 w-full' />
            <small className='text-gray-500'>(Res. recomendada: 1280x720)</small>
          </div>
          <textarea
